...
import {
  ...
  useForwardedInput
} from "./chunk-R5G4KET6.js";
import {
  Link_default,
  getLinkUtilityClass,
  linkClasses_default
} from "./chunk-F4KQFPRH.js";
import {
...
} from "./chunk-TIQUQMXF.js";
import {
  Button_default,
  buttonClasses_default,
  getButtonStyles,
  getButtonUtilityClass
} from "./chunk-X5ULV7IJ.js";
import {
...
import {
  ...
  getChipUtilityClass,
  useVariantColor
} from "./chunk-D5QC67LM.js";
import {
  Container_default,
  containerClasses_default,
  getContainerUtilityClass
} from "./chunk-XS4M6NFJ.js";
import {
  FormControl_default,
...
} from "./chunk-6KQMQZPX.js";
import {
  CssBaseline_default
} from "./chunk-WLANHHPW.js";
import {
  GlobalStyles_default
} from "./chunk-LXGV4HY7.js";
import {
  DividerRoot,
  Divider_default,
  dividerClasses_default,
  getDividerUtilityClass
} from "./chunk-4MPDY6LA.js";
import {
  FormLabel_default,
  formLabelClasses_default,
  getFormLabelUtilityClass
} from "./chunk-OLUB7JSW.js";
import {
  FormControlContext_default
} from "./chunk-EIVG2IOL.js";
import {
  Alert_default,
  alertClasses_default,
  getAlertUtilityClass
} from "./chunk-T4QXU5S4.js";
...
} from "./chunk-LHS56PGG.js";
import "./chunk-M2NWK6WO.js";
import {
  Avatar_default,
  avatarClasses_default,
  createSvgIcon,
  getAvatarUtilityClass
} from "./chunk-4QW7S3VB.js";
import {
  SvgIcon_default,
...
import {
  ...
  useTabsList,
  valueToPercent
} from "./chunk-BK2QMEZM.js";
import "./chunk-VI4ESFS6.js";
import {
  useButton
    ...
    children: (0, import_jsx_runtime.jsx)(NestedListContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime2.jsxs)(SlotRoot, _extends({}, rootProps, {
        children: [startAction && (0, import_jsx_runtime.jsx)(SlotStartAction, _extends({}, startActionProps, {
          ...
          var _child$props;
          return React8.isValidElement(child) ? React8.cloneElement(child, _extends({}, index === 0 && {
            "data-first-child": ""
...
var ChipDelete = React22.forwardRef(function ChipDelete2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "JoyChipDelete"
  });
  ...
  const chipContext = React22.useContext(ChipContext_default);
  const {
    variant = variantProp,
  ...
  return (0, import_jsx_runtime15.jsx)(SlotRoot, _extends({}, restOfRootProps, {
    children: children != null ? children : _Cancel || (_Cancel = (0, import_jsx_runtime15.jsx)(Cancel_default, {}))
  }));
});
...
var Badge = React27.forwardRef(function Badge2(inProps, ref) {
  ...
  return (0, import_jsx_runtime22.jsxs)(SlotRoot, _extends({}, rootProps, {
    children: [children, (0, import_jsx_runtime21.jsx)(SlotBadge, _extends({}, badgeProps, {
...
var _excluded14 = ["children", "className", "size", "separator", "component", "slots", "slotProps"];
...
var Breadcrumbs = React28.forwardRef(function Breadcrumbs2(inProps, ref) {
  ...
  const allItems = React28.Children.toArray(children).filter((child) => {
    ...
    return (0, import_jsx_runtime23.jsx)(SlotLi, _extends({}, liProps, {
  ...
  return (0, import_jsx_runtime23.jsx)(TypographyInheritContext.Provider, {
    value: true,
    children: (0, import_jsx_runtime23.jsx)(SlotRoot, _extends({}, rootProps, {
      children: (0, import_jsx_runtime23.jsx)(SlotOl, _extends({}, olProps, {
        children: allItems.reduce((acc, current, index) => {
          if (index < allItems.length - 1) {
            acc = acc.concat(current, (0, import_jsx_runtime23.jsx)(SlotSeparator, _extends({}, separatorProps, {
              children: separator
            }), `separator-${index}`));
          } else {
            acc.push(current);
...
var _excluded15 = ["buttonFlex", "className", "component", "disabled", "size", "color", "variant", "children", "orientation", "slots", "slotProps", "spacing"];
...
var _excluded16 = ["className", "component", "children", "buttonFlex", "orientation", "slots", "slotProps"];
...
var _excluded17 = ["className", "component", "children", "orientation", "slots", "slotProps"];
...
var CardCover = React32.forwardRef(function CardCover2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "JoyCardCover"
  });
  ...
  return (0, import_jsx_runtime27.jsx)(SlotRoot, _extends({}, rootProps, {
    children: React32.Children.map(children, (child, index) => index === 0 && React32.isValidElement(child) ? React32.cloneElement(child, {
      "data-first-child": ""
    }) : child)
  }));
});
...
var CardOverflow = React33.forwardRef(function CardOverflow2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "JoyCardOverflow"
  });
...
var Check_default = createSvgIcon((0, import_jsx_runtime29.jsx)("path", {
...
var HorizontalRule_default = createSvgIcon((0, import_jsx_runtime30.jsx)("path", {
...
var defaultCheckedIcon = (0, import_jsx_runtime31.jsx)(Check_default, {});
var defaultIndeterminateIcon = (0, import_jsx_runtime31.jsx)(HorizontalRule_default, {});
var Checkbox = React36.forwardRef(function Checkbox2(inProps, ref) {
  ...
  return (0, import_jsx_runtime32.jsxs)(SlotRoot, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime32.jsxs)(SlotCheckbox, _extends({}, checkboxProps, {
      children: [(0, import_jsx_runtime31.jsx)(SlotAction, _extends({}, actionProps, {
        children: (0, import_jsx_runtime31.jsx)(SlotInput, _extends({}, inputProps))
      })), icon]
    })), label && (0, import_jsx_runtime31.jsx)(TypographyNestedContext.Provider, {
      value: true,
      children: (0, import_jsx_runtime31.jsx)(SlotLabel, _extends({}, labelProps, {
        children: label
      }))
    })]
  }));
...
var ModalDialogVariantColorContext = React38.createContext(void 0);
if (true) {
...
var DialogContent = React39.forwardRef(function DialogContent2(inProps, ref) {
  ...
  const context = React39.useContext(ModalDialogVariantColorContext_default);
  const {
    component = "div",
    children,
    orientation = "vertical",
...
var ModalDialogSizeContext = React40.createContext(void 0);
if (true) {
...
var _excluded26 = ["component", "children", "variant", "color", "level", "slots", "slotProps"];
...
var DialogTitle = React41.forwardRef(function DialogTitle2(inProps, ref) {
  ...
  const size = React41.useContext(ModalDialogSizeContext_default);
...
true ? DialogTitle.propTypes = {
   ...
   * The color of the component. It supports those theme colors that make sense for this component.
   */
  color: import_prop_types23.default.oneOf(["danger", "neutral", "primary", "success", "warning"]),
  /**
   * The component used for the root node.
   * Either a string to use a HTML element or a component.
   */
   ...
   */
  level: import_prop_types23.default.oneOf(["body-lg", "body-md", "body-sm", "body-xs", "h1", "h2", "h3", "h4", "inherit", "title-lg", "title-md", "title-sm"]),
  /**
   * The props used for each slot inside.
   * @default {}
   */
...
var CloseModalContext = React42.createContext(void 0);
if (true) {
...
var _excluded27 = ["children", "container", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "onClose", "onKeyDown", "open", "component", "slots", "slotProps"];
    ...
    children: (0, import_jsx_runtime36.jsx)(Portal, {
      ...
      children: (0, import_jsx_runtime37.jsxs)(SlotRoot, _extends({}, rootProps, {
        children: [!hideBackdrop ? (0, import_jsx_runtime36.jsx)(SlotBackdrop, _extends({}, backdropProps)) : null, (0, import_jsx_runtime36.jsx)(FocusTrap, {
          ...
          open,
          children: React43.Children.only(children) && React43.cloneElement(children, _extends({}, children.props.tabIndex === void 0 && {
            tabIndex: -1
          }))
        })]
      }))
...
var _excluded28 = ["children", "anchor", "container", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "color", "variant", "invertedColors", "size", "onClose", "onKeyDown", "open", "component", "slots", "slotProps"];
...
true ? Drawer.propTypes = {
   ...
   * @default 'md'
   */
  size: import_prop_types25.default.oneOf(["sm", "md", "lg"]),
  /**
   * The props used for each slot inside.
   * @default {}
   */
...
var _excluded31 = ["component", "role", "className", "children", "inset", "orientation", "slots", "slotProps"];
...
var ListDivider = React47.forwardRef(function ListDivider2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "JoyListDivider"
  });
  const row = React47.useContext(RowListContext_default);
  const listComponent = React47.useContext(ComponentListContext_default);
  const {
    component: componentProp,
    role: roleProp,
    className,
...
true ? ListDivider.propTypes = {
   ...
   * @default 'context'
   */
  inset: import_prop_types29.default.oneOfType([import_prop_types29.default.oneOf(["context", "gutter", "startDecorator", "startContent"]), import_prop_types29.default.string]),
  /**
   * The component orientation.
   * @default 'horizontal'
   */
...
var ListItemContent = React48.forwardRef(function ListItemContent2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "JoyListItemContent"
  });
...
var ListItemDecorator = React49.forwardRef(function ListItemDecorator2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "JoyListItemDecorator"
  });
  ...
  const parentOrientation = React49.useContext(ListItemButtonOrientationContext_default);
  const ownerState = _extends({
    parentOrientation
  }, props);
...
var _excluded35 = ["actions", "children", "color", "component", "disablePortal", "keepMounted", "id", "invertedColors", "onItemsChange", "modifiers", "variant", "size", "slots", "slotProps"];
...
var Menu = React50.forwardRef(function Menu2(inProps, ref) {
  ...
  return (0, import_jsx_runtime45.jsx)(MenuRoot, _extends({}, rootProps, !((_props$slots = props.slots) != null && _props$slots.root) && {
    as: Popper,
    slots: {
      root: component || "ul"
    }
  }, {
    children: (0, import_jsx_runtime45.jsx)(MenuProvider, {
      value: contextValue,
      children: (0, import_jsx_runtime45.jsx)(VariantColorProvider, {
        variant: invertedColors ? void 0 : variant,
        color,
        children: (0, import_jsx_runtime45.jsx)(GroupListContext_default.Provider, {
          value: "menu",
...
true ? Menu.propTypes = {
   ...
   * @default 'neutral'
   */
  color: import_prop_types32.default.oneOf(["danger", "neutral", "primary", "success", "warning"]),
  /**
   * The component used for the root node.
   * Either a string to use a HTML element or a component.
   */
...
var _excluded36 = ["children", "color", "component", "disabled", "endDecorator", "loading", "loadingPosition", "loadingIndicator", "size", "slotProps", "slots", "startDecorator", "variant"];
...
var MenuButton = React51.forwardRef(function MenuButton2(inProps, forwardedRef) {
  ...
  const buttonGroup = React51.useContext(ButtonGroupContext_default);
  ...
  return (0, import_jsx_runtime47.jsxs)(SlotRoot, _extends({}, rootProps, {
    children: [(startDecorator || loading && loadingPosition === "start") && (0, import_jsx_runtime46.jsx)(SlotStartDecorator, _extends({}, startDecoratorProps, {
      children: loading && loadingPosition === "start" ? loadingIndicator : startDecorator
    })), children, loading && loadingPosition === "center" && (0, import_jsx_runtime46.jsx)(SlotLoadingIndicatorCenter, _extends({}, loadingIndicatorCenterProps, {
      children: loadingIndicator
    })), (endDecorator || loading && loadingPosition === "end") && (0, import_jsx_runtime46.jsx)(SlotEndDecorator, _extends({}, endDecoratorProps, {
...
true ? MenuButton.propTypes = {
  ...
  slotProps: import_prop_types33.default.shape({
    ...
    loadingIndicatorCenter: import_prop_types33.default.oneOfType([import_prop_types33.default.func, import_prop_types33.default.object]),
  ...
  slots: import_prop_types33.default.shape({
    ...
    loadingIndicatorCenter: import_prop_types33.default.elementType,
...
var _excluded37 = ["children", "disabled", "component", "selected", "color", "orientation", "variant", "slots", "slotProps", "id"];
...
var MenuItem = React52.memo(React52.forwardRef(function MenuItem2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "JoyMenuItem"
  });
  ...
  return (0, import_jsx_runtime48.jsx)(ListItemButtonOrientationContext_default.Provider, {
    value: orientation,
...
var StableMenuItem = React52.forwardRef(function StableMenuItem2(props, ref) {
  const {
    contextValue,
    id
  } = useMenuItemContextStabilizer(props.id);
  return (0, import_jsx_runtime48.jsx)(ListContext.Provider, {
    value: contextValue,
    children: (0, import_jsx_runtime48.jsx)(MenuItem, _extends({}, props, {
      id,
      ref
    }))
  });
...
var _excluded38 = ["actions", "id", "component", "children", "size", "variant", "color", "onItemsChange", "slots", "slotProps"];
...
var MenuList = React53.forwardRef(function MenuList2(inProps, ref) {
  ...
  return (0, import_jsx_runtime49.jsx)(SlotRoot, _extends({}, rootProps, {
    children: (0, import_jsx_runtime49.jsx)(MenuProvider, {
...
true ? MenuList.propTypes = {
   ...
   * Function called when the items displayed in the menu change.
   */
  onItemsChange: import_prop_types35.default.func,
  /**
   * The size of the component (affect other nested list* components because the `Menu` inherits `List`).
   * @default 'md'
   */
...
var ModalClose = React54.forwardRef(function ModalClose2(inProps, ref) {
  ...
  const closeModalContext = React54.useContext(CloseModalContext_default);
  const modalDialogVariantColor = React54.useContext(ModalDialogVariantColorContext_default);
  ...
  const modalDialogSize = React54.useContext(ModalDialogSizeContext_default);
  ...
  return (0, import_jsx_runtime50.jsx)(SlotRoot, _extends({}, rootProps, {
    children: _CloseIcon || (_CloseIcon = (0, import_jsx_runtime50.jsx)(Close_default, {}))
  }));
});
...
var _excluded40 = ["className", "children", "invertedColors", "orientation", "color", "component", "variant", "size", "layout", "maxWidth", "minWidth", "slots", "slotProps"];
...
var ModalDialog = React55.forwardRef(function ModalDialog2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "JoyModalDialog"
  });
  ...
  return (0, import_jsx_runtime51.jsx)(ModalDialogSizeContext_default.Provider, {
    value: size,
    children: (0, import_jsx_runtime51.jsx)(ModalDialogVariantColorContext_default.Provider, {
      value: contextValue,
...
true ? ModalDialog.propTypes = {
   ...
   * @default 'center'
   */
  layout: import_prop_types37.default.oneOfType([import_prop_types37.default.oneOf(["center", "fullscreen"]), import_prop_types37.default.string]),
  /**
   ...
   */
  maxWidth: import_prop_types37.default.oneOfType([import_prop_types37.default.number, import_prop_types37.default.string]),
  /**
   ...
   */
  minWidth: import_prop_types37.default.oneOfType([import_prop_types37.default.number, import_prop_types37.default.string]),
  /**
   * The component orientation.
   * @default 'vertical'
   */
...
var ModalOverflow = React56.forwardRef(function ModalOverflow2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "JoyModalOverflow"
  });
  ...
  const onClose = React56.useContext(CloseModalContext_default);
...
var _excluded43 = ["component", "children", "disabled", "value", "label", "variant", "color", "slots", "slotProps"];
...
var Option = React57.memo(React57.forwardRef(function Option2(inProps, ref) {
...
var StableOption = React57.forwardRef(function StableOption2(props, ref) {
  const {
    contextValue
  } = useOptionContextStabilizer(props.value);
  return (0, import_jsx_runtime53.jsx)(ListContext.Provider, {
    value: contextValue,
    children: (0, import_jsx_runtime53.jsx)(Option, _extends({}, props, {
      ref
    }))
  });
});
true ? StableOption.propTypes = {
   ...
   */
  label: import_prop_types39.default.oneOfType([import_prop_types39.default.element, import_prop_types39.default.string]),
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
...
var _excluded44 = ["checked", "checkedIcon", "defaultChecked", "disabled", "disableIcon", "overlay", "label", "id", "name", "onBlur", "onChange", "onFocus", "onFocusVisible", "readOnly", "required", "color", "variant", "size", "uncheckedIcon", "value", "component", "slots", "slotProps"];
...
var Radio = React58.forwardRef(function Radio2(inProps, ref) {
  ...
  const id = useId(idOverride != null ? idOverride : formControl == null ? void 0 : formControl.htmlFor);
  const radioGroup = React58.useContext(RadioGroupContext_default);
...
true ? Radio.propTypes = {
   ...
   * @default 'neutral'
   */
  color: import_prop_types40.default.oneOfType([import_prop_types40.default.oneOf(["danger", "primary", "success", "warning"]), import_prop_types40.default.string]),
  /**
   * The component used for the root node.
   * Either a string to use a HTML element or a component.
   */
   ...
   * @default false
   */
  disableIcon: import_prop_types40.default.bool,
  /**
   * @ignore
   */
   ...
   * @default false
   */
  overlay: import_prop_types40.default.bool,
  /**
   * If `true`, the component is read only.
   */
  ...
  slotProps: import_prop_types40.default.shape({
    action: import_prop_types40.default.oneOfType([import_prop_types40.default.func, import_prop_types40.default.object]),
    ...
    radio: import_prop_types40.default.oneOfType([import_prop_types40.default.func, import_prop_types40.default.object]),
  ...
  slots: import_prop_types40.default.shape({
    action: import_prop_types40.default.elementType,
    ...
    radio: import_prop_types40.default.elementType,
   ...
   */
  uncheckedIcon: import_prop_types40.default.node,
  /**
   * The value of the component. The DOM API casts this to a string.
   */
...
var _excluded45 = ["className", "component", "children", "name", "defaultValue", "disableIcon", "overlay", "value", "onChange", "color", "variant", "size", "orientation", "role", "slots", "slotProps"];
...
var RadioGroup = React59.forwardRef(function RadioGroup2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "JoyRadioGroup"
  });
  ...
  return (0, import_jsx_runtime56.jsx)(RadioGroupContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime56.jsx)(SlotRoot, _extends({}, rootProps, {
      children: (0, import_jsx_runtime56.jsx)(FormControlContext_default.Provider, {
        value: void 0,
        children: React59.Children.map(children, (child, index) => React59.isValidElement(child) ? React59.cloneElement(child, _extends({}, index === 0 && {
          "data-first-child": ""
        }, index === React59.Children.count(children) - 1 && {
          "data-last-child": ""
        }, {
...
var _excluded46 = ["className", "component", "disableColorScheme", "slots", "slotProps"];
...
true ? ScopedCssBaseline.propTypes = {
   ...
   * @default false
   */
  disableColorScheme: import_prop_types42.default.bool,
  /**
   * The props used for each slot inside.
   * @default {}
   */
...
var Unfold_default = createSvgIcon((0, import_jsx_runtime58.jsx)("path", {
...
var _Unfold;
var _excluded47 = ["action", "autoFocus", "children", "defaultValue", "defaultListboxOpen", "disabled", "getSerializedValue", "placeholder", "listboxId", "listboxOpen", "onChange", "onListboxOpenChange", "onClose", "renderValue", "required", "value", "size", "variant", "color", "startDecorator", "endDecorator", "indicator", "aria-describedby", "aria-label", "aria-labelledby", "id", "name", "multiple", "slots", "slotProps"];
function defaultRenderValue(selectedOptions) {
  var _selectedOptions$labe;
  if (Array.isArray(selectedOptions)) {
    return (0, import_jsx_runtime59.jsx)(React62.Fragment, {
...
var Select = React62.forwardRef(function Select2(inProps, ref) {
  ...
  const _ref = props, {
    ...
    startDecorator,
    endDecorator,
    indicator = _Unfold || (_Unfold = (0, import_jsx_runtime59.jsx)(Unfold_default, {})),
  ...
  const handleOpenChange = React62.useCallback((isOpen) => {
  ...
  const selectedOption = React62.useMemo(() => {
  ...
  const modifiers = React62.useMemo(() => [...defaultModifiers, ...listboxProps.modifiers || []], [listboxProps.modifiers]);
  ...
  return (0, import_jsx_runtime60.jsxs)(React62.Fragment, {
    children: [(0, import_jsx_runtime60.jsxs)(SlotRoot, _extends({}, rootProps, {
      children: [startDecorator && (0, import_jsx_runtime59.jsx)(SlotStartDecorator, _extends({}, startDecoratorProps, {
        children: startDecorator
      })), (0, import_jsx_runtime59.jsx)(SlotButton, _extends({}, buttonProps, {
        children: displayValue
      })), endDecorator && (0, import_jsx_runtime59.jsx)(SlotEndDecorator, _extends({}, endDecoratorProps, {
        children: endDecorator
      })), indicator && (0, import_jsx_runtime59.jsx)(SlotIndicator, _extends({}, indicatorProps, {
        children: indicator
      })), (0, import_jsx_runtime59.jsx)("input", _extends({}, getHiddenInputProps()))]
    })), anchorEl && (0, import_jsx_runtime59.jsx)(SlotListbox, _extends({}, listboxProps, {
      className: clsx_default(listboxProps.className),
      modifiers
    }, !((_props$slots = props.slots) != null && _props$slots.listbox) && {
      as: Popper,
      ...
      children: (0, import_jsx_runtime59.jsx)(SelectProvider, {
        value: contextValue,
        children: (0, import_jsx_runtime59.jsx)(VariantColorProvider, {
          variant,
          color: colorProp,
...
true ? Select.propTypes = {
   ...
   * @default false
   */
  defaultListboxOpen: import_prop_types43.default.bool,
  /**
   ...
   */
  getSerializedValue: import_prop_types43.default.func,
  /**
   ...
   */
  listboxId: import_prop_types43.default.string,
  /**
   * Controls the open state of the select's listbox.
   * @default undefined
   */
  listboxOpen: import_prop_types43.default.bool,
  /**
   ...
   */
  onListboxOpenChange: import_prop_types43.default.func,
  /**
   * Text to show when there is no selected value.
   */
  placeholder: import_prop_types43.default.node,
  /**
...
var _excluded48 = ["className", "color", "component", "variant", "invertedColors", "slots", "slotProps"];
...
var Sheet = React63.forwardRef(function Sheet2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "JoySheet"
  });
...
var _excluded49 = ["className", "component", "children", "animation", "overlay", "loading", "variant", "level", "height", "width", "sx", "slots", "slotProps"];
var _2 = (t) => t;
var _t3;
var _t22;
var _t32;
...
var Skeleton = React64.forwardRef(function Skeleton2(inProps, ref) {
  ...
  return loading ? (0, import_jsx_runtime62.jsx)(SlotRoot, _extends({}, rootProps, {
    children
  })) : (0, import_jsx_runtime62.jsx)(React64.Fragment, {
    children: React64.Children.map(children, (child, index) => index === 0 && React64.isValidElement(child) ? React64.cloneElement(child, {
      "data-first-child": ""
    }) : child)
  });
});
true ? Skeleton.propTypes = {
   ...
   */
  height: import_prop_types45.default.oneOfType([import_prop_types45.default.arrayOf(import_prop_types45.default.oneOfType([import_prop_types45.default.number, import_prop_types45.default.string])), import_prop_types45.default.number, import_prop_types45.default.shape({
    lg: import_prop_types45.default.oneOfType([import_prop_types45.default.number, import_prop_types45.default.string]),
    md: import_prop_types45.default.oneOfType([import_prop_types45.default.number, import_prop_types45.default.string]),
    sm: import_prop_types45.default.oneOfType([import_prop_types45.default.number, import_prop_types45.default.string]),
    xl: import_prop_types45.default.oneOfType([import_prop_types45.default.number, import_prop_types45.default.string]),
    xs: import_prop_types45.default.oneOfType([import_prop_types45.default.number, import_prop_types45.default.string])
  }), import_prop_types45.default.string]),
  /**
   * Applies the theme typography styles.
   * @default variant === 'text' ? 'body-md' : 'inherit'
   */
  level: import_prop_types45.default.oneOfType([import_prop_types45.default.oneOf(["h1", "h2", "h3", "h4", "title-lg", "title-md", "title-sm", "body-lg", "body-md", "body-sm", "body-xs", "inherit"]), import_prop_types45.default.string]),
  /**
   ...
   * @default 'overlay'
   */
  variant: import_prop_types45.default.oneOfType([import_prop_types45.default.oneOf(["circular", "inline", "overlay", "rectangular", "text"]), import_prop_types45.default.string]),
  /**
   * Width of the skeleton.
   * Useful when the skeleton is inside an inline element with no width of its own.
   */
  width: import_prop_types45.default.oneOfType([import_prop_types45.default.arrayOf(import_prop_types45.default.oneOfType([import_prop_types45.default.number, import_prop_types45.default.string])), import_prop_types45.default.number, import_prop_types45.default.shape({
    lg: import_prop_types45.default.oneOfType([import_prop_types45.default.number, import_prop_types45.default.string]),
    md: import_prop_types45.default.oneOfType([import_prop_types45.default.number, import_prop_types45.default.string]),
    sm: import_prop_types45.default.oneOfType([import_prop_types45.default.number, import_prop_types45.default.string]),
    xl: import_prop_types45.default.oneOfType([import_prop_types45.default.number, import_prop_types45.default.string]),
...
var _excluded50 = ["aria-label", "aria-valuetext", "className", "classes", "disableSwap", "disabled", "defaultValue", "getAriaLabel", "getAriaValueText", "marks", "max", "min", "name", "onChange", "onChangeCommitted", "onMouseDown", "orientation", "shiftStep", "scale", "step", "tabIndex", "track", "value", "valueLabelDisplay", "valueLabelFormat", "isRtl", "color", "size", "variant", "component", "slots", "slotProps"];
function Identity(x) {
  return x;
}
...
var Slider = React65.forwardRef(function Slider2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "JoySlider"
  });
  ...
  return (0, import_jsx_runtime64.jsxs)(SlotRoot, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime63.jsx)(SlotRail, _extends({}, railProps)), (0, import_jsx_runtime63.jsx)(SlotTrack, _extends({}, trackProps)), marks.filter((mark) => mark.value >= min && mark.value <= max).map((mark, index) => {
      ...
      return (0, import_jsx_runtime64.jsxs)(React65.Fragment, {
...
var _excluded51 = ["anchorOrigin", "animationDuration", "autoHideDuration", "color", "children", "className", "component", "disableWindowBlurListener", "endDecorator", "invertedColors", "onBlur", "onClose", "onFocus", "onMouseEnter", "onMouseLeave", "onUnmount", "open", "resumeHideDuration", "size", "slots", "slotProps", "startDecorator", "variant"];
var _3 = (t) => t;
var _t6;
var _t23;
...
var Snackbar = React66.forwardRef(function Snackbar2(inProps, ref) {
  ...
  const [exiting, setExiting] = React66.useState(false);
  const unmountRef = React66.useRef(onUnmount);
...
true ? Snackbar.propTypes = {
   ...
   * @default 300
   */
  animationDuration: import_prop_types47.default.number,
  /**
   ...
   */
  onUnmount: import_prop_types47.default.func,
  /**
   * If `true`, the component is shown.
   */
   ...
   * @default 'md'
   */
  size: import_prop_types47.default.oneOf(["sm", "md", "lg"]),
  /**
   * The props used for each slot inside.
   * @default {}
   */
  slotProps: import_prop_types47.default.shape({
    clickAway: import_prop_types47.default.oneOfType([import_prop_types47.default.func, import_prop_types47.default.shape({
      ...
      onClickAway: import_prop_types47.default.func.isRequired,
  ...
  slots: import_prop_types47.default.shape({
    clickAway: import_prop_types47.default.elementType,
   ...
   * @default 'outlined'
   */
  variant: import_prop_types47.default.oneOf(["outlined", "plain", "soft", "solid"])
} : void 0;
...
var _excluded53 = ["className", "component", "size", "children", "orientation", "slots", "slotProps"];
...
true ? Stepper.propTypes = {
   ...
   * @default 'md'
   */
  size: import_prop_types48.default.oneOfType([import_prop_types48.default.oneOf(["lg", "md", "sm"]), import_prop_types48.default.string]),
  /**
   * The props used for each slot inside.
   * @default {}
   */
...
var _excluded54 = ["active", "completed", "className", "component", "children", "disabled", "orientation", "indicator", "slots", "slotProps"];
...
var _excluded55 = ["className", "component", "children", "slots", "slotProps"];
...
var _excluded56 = ["className", "component", "color", "children", "variant", "slots", "slotProps"];
...
var StepIndicator2 = React70.forwardRef(function StepIndicator3(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "JoyStepIndicator"
  });
...
var _excluded57 = ["checked", "defaultChecked", "disabled", "onBlur", "onChange", "onFocus", "onFocusVisible", "readOnly", "required", "id", "color", "variant", "size", "startDecorator", "endDecorator", "component", "slots", "slotProps"];
...
true ? Switch.propTypes = {
   ...
   * @default 'neutral'
   */
  color: import_prop_types52.default.oneOfType([import_prop_types52.default.oneOf(["danger", "primary", "success", "warning"]), import_prop_types52.default.string]),
  /**
   * The component used for the root node.
   * Either a string to use a HTML element or a component.
   */
   ...
   */
  endDecorator: import_prop_types52.default.oneOfType([import_prop_types52.default.node, import_prop_types52.default.func]),
  /**
   * @ignore
   */
  ...
  slotProps: import_prop_types52.default.shape({
    action: import_prop_types52.default.oneOfType([import_prop_types52.default.func, import_prop_types52.default.object]),
  ...
  slots: import_prop_types52.default.shape({
    action: import_prop_types52.default.elementType,
   ...
   * The element that appears at the end of the switch.
   */
  startDecorator: import_prop_types52.default.oneOfType([import_prop_types52.default.node, import_prop_types52.default.func]),
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
...
var _excluded58 = ["action", "children", "value", "disabled", "onChange", "onClick", "onFocus", "component", "orientation", "variant", "color", "disableIndicator", "indicatorPlacement", "indicatorInset", "slots", "slotProps"];
...
true ? Tab.propTypes = {
   ...
   * @default false
   */
  disableIndicator: import_prop_types53.default.bool,
  /**
   * If `true`, the indicator stay within the padding based on the `Tabs` orientation.
   * @default false
   */
  indicatorInset: import_prop_types53.default.bool,
  /**
   * The indicator's position when the Tab is selected.
   * @default row ? 'bottom' : 'right'
   */
  indicatorPlacement: import_prop_types53.default.oneOf(["bottom", "left", "right", "top"]),
  /**
...
true ? Table.propTypes = {
   ...
   * @default 'xBetween'
   */
  borderAxis: import_prop_types54.default.oneOfType([import_prop_types54.default.oneOf(["both", "bothBetween", "none", "x", "xBetween", "y", "yBetween"]), import_prop_types54.default.string]),
  /**
   ...
   * @default false
   */
  hoverRow: import_prop_types54.default.bool,
  /**
   ...
   * @default false
   */
  noWrap: import_prop_types54.default.bool,
  /**
   * The size of the component.
   * It accepts theme values between 'sm' and 'lg'.
   * @default 'md'
   ...
   * @default false
   */
  stickyFooter: import_prop_types54.default.bool,
  /**
   ...
   */
  stripe: import_prop_types54.default.oneOfType([import_prop_types54.default.oneOf(["odd", "even"]), import_prop_types54.default.string]),
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
...
var SizeTabsContext = React74.createContext("md");
if (true) {
...
var TabList = React75.forwardRef(function TabList2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "JoyTabList"
  });
  const tabsSize = React75.useContext(SizeTabsContext_default);
  const {
    isRtl,
    orientation,
    getRootProps,
...
true ? TabList.propTypes = {
   ...
   */
  sticky: import_prop_types55.default.oneOf(["bottom", "top"]),
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
   ...
   */
  tabFlex: import_prop_types55.default.oneOfType([import_prop_types55.default.number, import_prop_types55.default.string]),
  /**
   * The placement of the TabList's underline.
   * @default orientation === 'horizontal' ? 'bottom' : 'right'
   */
  underlinePlacement: import_prop_types55.default.oneOf(["bottom", "left", "right", "top"]),
  /**
   * The [global variant](https://mui.com/joy-ui/main-features/global-variants/) to use.
   * @default 'plain'
   */
...
var TabPanel = React76.forwardRef(function TabPanel2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "JoyTabPanel"
  });
...
true ? Tabs.propTypes = {
   ...
   * The default value. Use when the component is not controlled.
   */
  defaultValue: import_prop_types57.default.oneOfType([import_prop_types57.default.number, import_prop_types57.default.string]),
  /**
...
var Textarea = React78.forwardRef(function Textarea2(inProps, ref) {
...
var _excluded64 = ["buttonFlex", "className", "component", "disabled", "size", "color", "variant", "children", "onChange", "orientation", "slots", "slotProps", "spacing", "value"];
...
var ToggleButtonGroup = React79.forwardRef(function ToggleButtonGroup2(inProps, ref) {
  ...
  const buttonGroupContext = React79.useMemo(() => ({
    variant,
    color,
    size,
    disabled
  ...
  const toggleButtonGroupContext = React79.useMemo(() => ({
  ...
  return (0, import_jsx_runtime81.jsx)(SlotRoot, _extends({}, rootProps, {
    children: (0, import_jsx_runtime81.jsx)(ToggleButtonGroupContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime81.jsx)(ButtonGroupContext_default.Provider, {
        value: buttonGroupContext,
        children: React79.Children.map(children, (child, index) => {
          ...
          if (index === React79.Children.count(children) - 1) {
            extraProps["data-last-child"] = "";
          }
          return React79.cloneElement(child, extraProps);
        })
      })
    })
  }));
...
true ? ToggleButtonGroup.propTypes = {
   ...
   * @default 'md'
   */
  size: import_prop_types59.default.oneOf(["sm", "md", "lg"]),
  /**
   * The props used for each slot inside.
   * @default {}
   */
   ...
   * The value must have reference equality with the option in order to be selected.
   */
  value: import_prop_types59.default.oneOfType([import_prop_types59.default.arrayOf(import_prop_types59.default.string), import_prop_types59.default.string]),
  /**
   * The [global variant](https://mui.com/joy-ui/main-features/global-variants/) to use.
   * @default 'outlined'
   */
...
var Tooltip = React80.forwardRef(function Tooltip2(inProps, ref) {
  ...
  const prevUserSelect = React80.useRef(void 0);
  ...
  return (0, import_jsx_runtime83.jsxs)(React80.Fragment, {
    children: [React80.isValidElement(children) && React80.cloneElement(children, childrenProps), (0, import_jsx_runtime83.jsxs)(SlotRoot, _extends({}, rootProps, !((_props$slots = props.slots) != null && _props$slots.root) && {
      as: Popper,
      slots: {
        root: component || "div"
      }
